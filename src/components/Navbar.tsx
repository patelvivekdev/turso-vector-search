    ...
    <header className="flex flex-col">
      <div className="border border-red-400 bg-red-200 px-4 py-2 text-center text-sm">
        <p className="line-clamp-2">
          ⚠️ This is a demo application using Turso as vector DB, Google Gemini 🤖 AI Model and
          Embedding Model.
        </p>
      </div>
      <div className="flex flex-col items-center justify-between gap-4 border-b p-4 sm:flex-row">
        <Link href="/" className="text-foreground text-center text-lg font-medium sm:text-left">
